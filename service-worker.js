const CACHE_NAME = "alion-pwa-v57-workout-template-v2";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=20260831-workout-template-v2",
  ...
  "./modules/workout-template-v2.js?v=20260831-template-v2",
  "./modules/workout-template-v2-reader.js?v=20260831-template-v2",
  "./modules/workout-template-reader.js?v=20260831-template-v2",
  ...
  "./modules/workout-import-review.js?v=20260831-import-v2",
  "./modules/trainer-data-rules.js?v=20260728-trainer-fixes",
  "./app.js?v=20260831-workout-template-v2",
